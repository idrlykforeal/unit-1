...
|-----|----------------|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | Functional     | register()           | 1. generate test_register.py and call register function  2. follow the instructions displayed and input username and password                    | database file user_psw.csv will be written with tt ht the registered username                                                                                                                                                                                                                                                                              |
| 2   | Functional     | login()              | 1. generate test_login.py and call login function  2. input wrong username/password  3. input correct username and password                      | when either username or password is incorrect, the system prints "Incorrect username or password, please try again", and asks the user to re-input until the username and password are correct                                                                                                                                                             |
| 3   | Functional     | print_transactions() | 1. generate test_print_transactions.py and call function                                                                                         | user get an output of a table with all the details of transactions including the amount, action, date, and remark                                                                                                                                                                                                                                          |
| 4   | Non-functional | get_options()        | 1. check whether functions have clear instructions that guide the users  2. check whether the messages of error is explicit and self explanitory | 1. initial instructional messages are clear, displaying all the options with index, and the line of input states what type of input the system is looking for--integers from 1-5  2. error messages are also clear and explicit, including why the error is made--invalid number of input, and gives out instructions "please re-input youroption [1-5]: " |
| 5   | Non-functional | print_balance        | 1. go to function print_balance  2. check coding practice: if the variables' names are explanitory                                               | The variables used are well-named, all having the name according to their use and their status--"stripped", "raw", etc.                                                                                                                                                                                                                                    |
| 6   | Non-functional | register_or_login()  | 1. go to function register_or_login  2. check coding practice: if the function is well commented, and coded with proper practice                 | function is well commented, with the main purpose of the function, types of inputs and outputs commented. Also, in the defining stage, the types of inputs and outputs are also written.                                                                                                                                                                   |
